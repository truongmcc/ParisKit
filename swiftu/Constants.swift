...
struct Constants {
    ...
    static let dicoType = ["Velib":"velib","AutoLib":"autolib","Taxis":"taxi","Arbres":"arbres","Sanisettes":"sanisettes","Capotes":"capotes","Fontaines":"fontaines","Belibs":"belibs","Cafes":"cafes"] as [String:String]
